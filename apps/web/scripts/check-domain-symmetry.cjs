...
function main() {
  ...
  if (!report.ok) {
    console.error('[check-domain-symmetry] Web domain symmetry check failed.');
  ...
  console.log(
    `[check-domain-symmetry] Web domain symmetry check passed (${report.checked_capabilities} capabilities checked).`
  );
}
