...
const PlatformOrgManagementPage = lazy(() => import('../org/PlatformOrgManagementPage'));
const PlatformRoleManagementPage = lazy(() => import('../role/PlatformRoleManagementPage'));
const PlatformUserManagementPage = lazy(() => import('../user/PlatformUserManagementPage'));
