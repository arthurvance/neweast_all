...
SET @uk_auth_user_tenants_membership_id_drop_sql = IF(
  ...
  'ALTER TABLE auth_user_tenants DROP INDEX uk_auth_user_tenants_membership_id',
  'SELECT 1'
);
...
SET @idx_auth_user_tenants_tenant_status_drop_sql = IF(
  ...
  'ALTER TABLE auth_user_tenants DROP INDEX idx_auth_user_tenants_tenant_status',
  'SELECT 1'
);
