...
- `pnpm --dir apps/api exec node --test test/auth.service.test.js test/platform.role.api.test.js test/tenant.role.api.test.js` → `369 passed`
- `pnpm --dir apps/api check:route-permissions` → `passed`
- `pnpm --dir apps/api lint` → `Lint passed (73 files checked)`
- `pnpm --dir apps/api test` → `993 passed`
